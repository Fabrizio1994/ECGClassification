...
class FeatureExtraction:
    ...
    def extract_features(self, signal_name, rpeak_locations, window_size, feature_group, channels_ids=[0, 1]):
        print("Extracting features for signal " + signal_name + "...")
        record = wfdb.rdrecord(signal_name, channels=channels_ids)
